...
namespace Yaam.Infrastructure.Migrations
{
    ...
    [Migration("20260718221643_AddReminderFilteredUniqueIndex")]
    partial class AddReminderFilteredUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Yaam.Domain.Entities.Reminder", b =>
                {
                    b.HasOne("Yaam.Domain.Entities.Application", "Application")
                        .WithOne("Reminder")
                        .HasForeignKey("Yaam.Domain.Entities.Reminder", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
